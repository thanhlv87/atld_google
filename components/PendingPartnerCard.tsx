...
const PendingPartnerCard: React.FC<PendingPartnerCardProps> = ({
  partner,
  onApprove,
  onReject,
  onViewDetails,
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-5 transition-shadow hover:shadow-xl flex flex-col justify-between">
      <div>
        <h3 className="text-lg font-bold text-neutral-dark truncate" title={partner.email}>
          {partner.email}
        </h3>
        ...
        <div className="text-sm text-gray-700 space-y-1">
          <p>
            <strong>
              <i className="fas fa-phone w-4 text-center mr-1"></i> SĐT:
            </strong>{' '}
            {partner.phone}
          </p>
          <p>
            <strong>
              <i className="fas fa-map-marker-alt w-4 text-center mr-1"></i> Địa chỉ:
            </strong>{' '}
            {partner.address}
          </p>
        </div>
